...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'plugs',
        component: RouteView,
        meta: { title: 'menu.plugs', keepAlive: true, icon: bxAnaalyse, permission: ['plugs'] },
        children: [
          {
            path: '/plugs/plugsManager',
            name: 'plugs',
            component: () => import('@/views/plugs/PlugsManager'),
            meta: { title: 'menu.plugs.plugs', keepAlive: true, permission: ['plugs'] }
          }
        ]
      },
      {
