 ...
 * @author solley
 */
class MmqStateMachine extends StateMachineAdapter {
    ...
    MmqStateMachine(JRaftServer server, RequestProcessor4CP processor) {
        this.server = server;
    ...
    private void postProcessor(Response data, MmqClosure closure) {
