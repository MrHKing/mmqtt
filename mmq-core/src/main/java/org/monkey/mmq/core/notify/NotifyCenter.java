...
import org.monkey.mmq.core.notify.listener.SmartSubscriber;
...
public class NotifyCenter {
    ...
    static {
        ...
        String ringBufferSizeProperty = "mmq.core.notify.ring-buffer-size";
        ringBufferSize = Integer.getInteger(ringBufferSizeProperty, 16384);
        
        // The size of the public publisher's message staging queue buffer
        String shareBufferSizeProperty = "mmq.core.notify.share-buffer-size";
        shareBufferSize = Integer.getInteger(shareBufferSizeProperty, 1024);
        
        final Collection<EventPublisher> publishers = MmqServiceLoader.load(EventPublisher.class);
        ...
        DEFAULT_PUBLISHER_FACTORY = (cls, buffer) -> {
            try {
                ...
                throw new MmqRuntimeException(SERVER_ERROR, ex);
            }
        };
