...
public class InternetAddressUtil {
    ...
    public static String[] splitIPPortStr(String str) {
        ...
        if (str.startsWith(IPV6_START_MARK) && MmqStringUtils.containsIgnoreCase(str, IPV6_END_MARK)) {
    ...
    public static String getIPFromString(String str) {
        ...
        String result = "";
        if (MmqStringUtils.containsIgnoreCase(str, IPV6_START_MARK) && MmqStringUtils.containsIgnoreCase(str, IPV6_END_MARK)) {
