...
import org.monkey.mmq.core.cluster.MemberLookup;
...
public final class LookupFactory {
    ...
    private static final String LOOKUP_MODE_TYPE = "mmq.core.member.lookup.type";
     ...
     */
    public static MemberLookup createLookUp(ServerMemberManager memberManager) throws MmqException {
     ...
     * @param memberManager {@link ServerMemberManager}
     * @return {@link MemberLookup}
     * @throws MmqException {@link MmqException}
     */
    public static MemberLookup switchLookup(String name, ServerMemberManager memberManager) throws MmqException {
    ...
    public static void destroy() throws MmqException {
