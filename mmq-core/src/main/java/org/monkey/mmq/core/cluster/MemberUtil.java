...
import org.monkey.mmq.core.utils.ExceptionUtil;
import org.monkey.mmq.core.utils.InternetAddressUtil;
...
public class MemberUtil {
    ...
    private static final String MEMBER_FAIL_ACCESS_CNT_PROPERTY = "mmq.core.member.fail-access-cnt";
     ...
     *
     * @param addresses ip list, example [127.0.0.1:8847,127.0.0.1:8888,127.0.0.1:8849]
     * @return member list
     */
    ...
    /**
     * Default configuration format resolution, only MMQ-Server IP or IP :port or hostname: Port information.
     */
