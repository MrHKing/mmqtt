...
package org.monkey.mmq.core.exception;
 ...
 * @author solley
 */
public class MmqException extends Exception {
    ...
    public MmqException(final int errCode, final String errMsg) {
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }

    public MmqException(final int errCode, final Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        this.setCauseThrowable(throwable);
    }

    public MmqException(final int errCode, final String errMsg, final Throwable throwable) {
    ...
    /**
     * http client error code, ome exceptions that occurred when the use the MMQ RestTemplate and MMQ
     * AsyncRestTemplate.
     */
