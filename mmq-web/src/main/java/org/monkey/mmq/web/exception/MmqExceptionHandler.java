...
package org.monkey.mmq.web.exception;
 ...
 */
@ControllerAdvice
public class MmqExceptionHandler {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(MmqExceptionHandler.class);
