...
import org.monkey.mmq.rule.engine.supports.map.SingleParameterFunctionMapFeature;
...
public class ReactorQLTest {
    ...
    @Test
    public void testGroupByWindowEmpty() {
        ReactorQL.builder()
    ...
    @Test
    public void testGroupByTimeHaving() {
    ...
    @Test
    public void testWhereFromSelect() {
        ReactorQL.builder()
...
//                        "where t1.v=t2.v and t3.v=t2.v"
    ...
    @Test
    public void testDistinctOnTable() {
        ReactorQL.builder()
    ...
    @Test
    public void testAllColumnTable() {
        ReactorQL.builder()
    ...
    @Test
    public void testGroupTakeFirst() {
        ReactorQL.builder()
    ...
    @Test
    public void testGroupTimeProperty() {
        String[] sql = {""
                // ,"select * from("
    ...
    @Test
    public void testGroupTraceInfo() {
        ReactorQL.builder()
